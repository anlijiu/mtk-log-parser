...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [3] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_logs, 0, 0, 0),
  ...
  [19] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_time, 7, 0, 4),
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 7, 0, 4),
  [23] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tid, 1, 0, 0),
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tid, 1, 0, 0),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_logs, 1, 0, 0),
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_logs_repeat1, 2, 0, 0),
  [31] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_logs_repeat1, 2, 0, 0), SHIFT_REPEAT(9),
  [34] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_logs_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
  [37] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_begin_header_repeat1, 2, 0, 0), SHIFT_REPEAT(8),
  [40] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_begin_header_repeat1, 2, 0, 0),
  [42] = {.entry = {.count = 1, .reusable = false}}, SHIFT(8),
  [44] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_begin_header, 2, 0, 0),
  [48] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_message, 1, 0, 0),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ide_log_line, 6, 0, 0),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_log_line, 7, 0, 0),
  [54] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [56] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_date, 3, 0, 1),
  ...
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_date, 5, 0, 2),
  [78] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [80] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [82] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_priority, 1, 0, 0),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pid, 1, 0, 0),
  [88] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_thread_name, 3, 0, 3),
...
TS_PUBLIC const TSLanguage *tree_sitter_androidlog(void) {
